...
function financialCase(patch: Partial<RegistrationFinancialCase> = {}): RegistrationFinancialCase {
  return { id: "case-1", ownerId: "user-1", clientName: "Cliente Exemplo", processReference: "PROC-1", registryOffice: "1º Cartório", city: "São Paulo", controlNumber:null,signingDate:null,referralSource:"",bankBranch:"",iqStatus:null,paymentStatus:null,collectionStatus:null,itbiAmountCents:0,itbiPaymentStatus:null,protocolReference:"",registryCostsCents:0,registryCostsPaymentStatus:null,operationalStatus:"",operationalStatusUpdatedAt:null,bankDeliveryDate:null,sellerPaymentStatus:null,sellerPaymentDate:null, operationMode: "FULL_PAYMENT_TO_GOODCREDIT", advisoryFeeExpectedCents: 200_000, estimatedItbiCents: 0, estimatedRegistryCents: 0, estimatedOtherCostsCents: 0, notes: "", financialFinalizedAt: null, openedAt: "2026-07-31", archivedAt: null, createdAt: "2026-07-31T12:00:00Z", updatedAt: "2026-07-31T12:00:00Z", ...patch };
}
